...
public class CmdAddZone implements CommandExecutor
{
	@Override
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
	{
		...
		PvP.getCoreData().addZone(world, region);
		sender.sendMessage(ChatColor.WHITE + "Added zone " + ChatColor.RED + region.getId() + ChatColor.WHITE + " in world " + ChatColor.RED + world.getName() + ChatColor.WHITE + " to the system");
		return true;
	}
